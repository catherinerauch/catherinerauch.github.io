...
###Time Series Analysis and Forecast of Southern Resident Killer Whale (SRKW) Sightings
```{r, echo=FALSE, out.width="45%",out.height="20%",fig.cap="   ",fig.show='hold',fig.align='left'}
...
### Exploratory Analysis of Shark Tank Data
```{r, echo=FALSE, out.width="49%",out.height="100%",fig.cap="   ",fig.show='hold',fig.align='left'}
